...
import ImageSlider from '@/components/sliderPaintscaleInterface';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 py-8">
        ...
        <div className="p-6 rounded-lg shadow bg-white">
          <ul className="space-y-2 list-disc pl-6">
            <li className="text-black">Akzo Nobel™ </li>
            <li className="text-black">BASF™  </li>
          </ul>
        </div>
        ...
        <div className="p-6 rounded-lg shadow bg-white">
          <ul className="space-y-2 list-disc pl-6">
            <li className="text-black">Sherwin Williams™ </li>
            <li className="text-black">PPG™ </li>
          </ul>
        </div>
      </div>
